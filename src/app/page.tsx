  ...
  <div className="relative z-10 w-full max-w-7xl px-6 py-12 flex flex-col items-center mt-12">
    ...
    <div className="w-96 flex flex-col items-center justify-center mb-6 mt-8 relative z-20" style={{ pointerEvents: 'auto' }}>
      ...
      <div className="relative w-full flex flex-col items-center justify-center py-4">
        ...
        />
        <p className="font-b612 text-xl md:text-2xl text-white-200 mb-6 text-center whitespace-nowrap tracking-[3.5%] leading-[120%]">
...
<p className="font-b612 text-xl text-lg font-semibold text-yellow-300 group-hover:text-yellow-400 transition-colors whitespace-nowrap">
  ...
  { name: "Cosplay", gradient: "from-yellow-500 to-amber-500", textColor: "text-amber-400", image: "c8e8c933bdf438d5183b8bba2a38bb05b3da2978.png" }
].map((item, index) => (
  <div 
    key={index}
  ...
  >
    ...
    {/* Promotional text */}
    <div className="w-full max-w-4xl text-center group px-4">
  ...
  <div className="relative z-10 container mx-auto px-6 text-center">
    ...
    {/* Carousel Wrapper */}
    <div className="overflow-hidden w-full px-12"> {/* Added padding to the sides */}
      <div
        ref={scrollRef}
        className="flex gap-10 overflow-x-auto scroll-smooth scrollbar-hide py-2"
      >
        {[
          "9e34dcbe113a11f5620fb45103e5662028c542e4.png",
          "75bb87e54d0a21ca43dc1b109c8abe6db428c15a.png",
          "817ce6fd2f70b13123097e00cbff9c4e647ef04d.png",
          "a5eb54fc7d11e01640fd68489a7dc575ea243ca7.png",
          "ae8239e4cba6300f5e8833b575477c178638403d.png",
          "b4a6aa482c5b12d2782a9cb5d11f3b782e069e51.png",
          "cc7b3388d021b1805ae7cb0a13ac11b82f03f58c.png",
          "ecc1c2d08c80e4170fe472aaf31db3ad844d2c7d.png",
          "efdec32fcec82aee6c9de750131b3d447c90cf13.png",
          "faf28aa3d112f61c2cd31a84c7e3fc3b389279a6.png"
        ].map((logo, index) => (
          <img
            key={index}
            src={`/brands/${logo}`}
            alt={`Brand ${index + 1}`}
            className="h-20 flex-shrink-0 transition duration-300"
          />
        ))}
      </div>
    </div>
